export const Experience = [
    ...
    {
        no: 2,
        title: 'Internship Industry 4.0',
        location: 'Compserv Consultant Pvt Ltd, Kolhapur.',
        time: 'Dec 2019 – Jan 2020',
        description: 'Visited several local industries and studied their automation systems, SCADA, HMI and different types of sensors. Studied real world examples of automated factories using actuators and sensors.'
    }
